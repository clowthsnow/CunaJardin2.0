                    ...
                    <section id="content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Padres</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Usuarios
                                            </li>
                                            <li class="active blue-text">Ver Padres</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Ver padres</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos las Padres almacenados en el sistema y poder gestionarlas.
                                            </p>
                                            <div class="divider"></div>
                                            <div class="container">
                                                <!--DataTables example-->
                                                <div id="table-datatables">
                                                    <h4 class="header">Padres:</h4>
                                                    <div class="row">
                                                            ...
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['PadreDni'] . "</td>
                                                                        <td>" . $row['PadreNombre'] . "</td>
                                                                        <td>" . $row['PadreApellidos'] . "</td>
                                                                        <td>" . $row['PadreCorreo'] . "</td>
                                                                        <td>" . $row['PadreTelefono'] . "</td>";
                                                                        
                                                                        
                                                                        echo "<td><a href=\"page-configurar-padre.php?id=" . $row['PadreDni'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarPadre.php?id=" . $row['PadreDni'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
                        ...
                        <div id="modal1" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Padre no se encontrado en la base de datos</p>
                            </div>
