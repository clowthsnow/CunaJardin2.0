                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Ver Director</li>
                                        </ol>
                                                            ...
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['DirectorDni'] . "</td>
                                                                        <td>" . $row['DirectorNombre'] . "</td>
                                                                        <td>" . $row['DirectorApellido'] . "</td>
                                                                        <td>" . $row['DirectorTelefono'] . "</td>
                                                                        <td>" . $row['DirectorEmail'] . "</td>";
                                                                        
                                                                        
                                                                        echo "<td><a href=\"page-configurar-director.php?id=" . $row['DirectorDni'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarDirector.php?id=" . $row['DirectorDni'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
