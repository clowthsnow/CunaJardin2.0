                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Crear Turno</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Curso
                                            </li>
                                            <li class="active blue-text" >Crear Turno</li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Nuevo Turno</h4>
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="control/crearTurno.php" method="POST">

                                                                
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="nombre" type="text" class="validate" name="nombreturno" required="">
