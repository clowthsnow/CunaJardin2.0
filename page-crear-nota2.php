...
//echo $usuario;
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            ...
                                            <p class="caption">
                                                En este panel usted podra vVer Competencias almacenados en el sistema y poder gestionarlas.
                                            </p>
                                            ...
                                            <div class="container">
                                                ...
                                                <form class="form-horizontal" id="loadlist" role="form">
                                                    <div class="form-group">
                                                        <label  for="inputEmail1" class="col-lg-2 control-label">Seleccionar Una competencia:</label>
                                                        <div class="col-lg-7">
                                                        ...
                                                        <div class="col-lg-offset-3">
                                                            <input type="hidden" name="team_id" value="<?php echo $_GET["id"]; ?>">
    ...
    <script>
        $("#loadlist").submit(function (e) {
            ...
            $.get("loadcalification.php", d, function (data) {
                console.log(data);
                $("#data").html(data);
