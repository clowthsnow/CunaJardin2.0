                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Administrador: <?php echo $provBD['AdministradorNombre'] . " " . $provBD['AdministradorApellidos']; ?> <br>
                                                            DNI: <?php echo $provBD['AdministradorDni'];?>
                                                        </h4>
                                                        <div class="row">
                                                            <form id="configurar" class="col s12" action="control/modificarAdministrador.php" method="POST">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="nombre" type="text" class="validate" name="nombreAdministrador" required="" value="<?php echo $provBD['AdministradorNombre']; ?>" onkeypress="return val(event)" minlength="2" maxlength="45" style="text-transform: capitalize;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="apellido" type="text" class="validate" name="apellidoAdministrador" required="" value="<?php echo $provBD['AdministradorApellidos']; ?>" onkeypress="return val(event)" minlength="2" maxlength="45" style="text-transform: capitalize;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="tipo" type="text" class="validate" name="tipoAdministrador" required="" value="<?php echo $provBD['AdministradorTipo']; ?>" hidden="">
                                                                        <label class="active" for="tipo" hidden="">Tipo:</label>
                                                                    </div>
                                                                </div>

                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="email" type="email" class="validate" name="emailAdministrador" required="" value="<?php echo $provBD['AdministradorCorreo']; ?>">
                                                        ...
                                                        <div class="row">
                                                            <div class="input-field col s12">
                                                                <input id="telefono" type="text" class="validate" name="telefonoAdministrador" required="" value="<?php echo $provBD['AdministradorTelefono']; ?>" minlength="9" maxlength="9" onkeypress="return num(event)">
