                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Modificar Nueva Boleta</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de la Contabilidad
                                            </li>
                                            <li class="active blue-text" >Modificar Nueva Boleta</li>
...
//                    $("#loader").fadeIn('slow');
                    $.ajax({
                        url: './ajax/productos_cotizacion3.php?action=ajax&page=' + page + '&q=' + q,
