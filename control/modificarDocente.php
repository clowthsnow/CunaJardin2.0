...
$actualiza1= "UPDATE docente SET DocenteNombre= '$nombre', DocenteApellidos='$apellido',DocenteTitulo='$titulo',DocenteCorreo ='$correo', "
        ...
        . "DocenteDireccionTrabajo ='$dirtrabajo', DocenteCentroTrabajo ='$centro', DocenteTipoSangre ='$sangre', DocenteVinculoUnsa ='$unsa', "
        . "DocenteVinculoEspecifica='$vin',DocenteSituacionLaboral ='$sit', DocenteSituacionDet ='$sitlab', DocenteTipo='$tipo', DocenteSeguro='$seguro', "
        . "DocenteSeguroDetalle ='$segsoc', DocenteFoto ='$foto', DocenteCurriculum='$cur' WHERE DocenteDni='$dni'";
if($conexion->query($actualiza1) === TRUE){
    echo '1';
}else{
    echo '0';
}
