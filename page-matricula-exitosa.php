                ...
                <div class="wrapper">
                    ...
                    <section id="content">
                                                    ...
                                                    <div class="card-panel">
                                                        ...
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col s12 m12 l12">
                                                                        <p>IMPRIMA LA DECLARACION JURADA, NO SE OLVIDE DE LLEVAR ESTA FIRMADA Y CON HUELLA DIGITAL.</p>
                                                                        <br><br><br>
                                                                    </div>
                                                                </div> 
                                                                <div class="divider"></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col s12 m12 l12">
                                                                        <a target="_blank" href="page-imprimir-declaracion.php?usuario=<?php echo $usuario?>" class="waves-effect waves-green btn">Imprimir Declaracion Jurada</a>
                                                                    </div>
                                                                </div> <br>
                                                                <div class="divider"></div>
                                                                <br>
                                                                <div class="row">
                                                                    <div class="col s12 m12 l12">
                                                                        <a href="index.php" class="waves-effect waves-green btn">Terminar</a>
                                                                    </div>
                                                                </div> 
                        ...
                        <div id="modal2" class="modal">
                            ...
                            <div class="modal-footer">
                                <a href="page-matricula-exitosa.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
                        </div>
                    </section>
                    <!-- END CONTENT -->
