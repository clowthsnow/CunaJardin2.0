                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Ver Contabilidad</li>
                                        </ol>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            ...
                                            <p class="caption">
                                                En este panel usted podra ver Contabilidad almacenados en el sistema y poder gestionarlas.
                                            </p>
                                            <div class="divider"></div>
                                            <div class="container">
                                                <!--DataTables example-->
                                                <div id="table-datatables">
                                                    <h4 class="header">Contabilidad:</h4>
                                                    <div class="row">
                                                            ...
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        ...
                                                                        echo "<td><a href=\"page-configurar-contabilidad.php?id=" . $row['ContabilidadId'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarContabilidad.php?id=" . $row['ContabilidadId'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
