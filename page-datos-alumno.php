                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        ...
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="control/crearEstudiante.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <input id="apellidos" type="text" class="validate" name="apellido" required="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col s12 m12 l12">
                                                                        <input id="fecha" type="text" class="datepicker" name="fechaNac" required="" value="<?php echo $fecha->format('Y-m-d'); ?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <input id="dnim" type="number" class="validate" name="dnim" required="" maxlength="8">
                                                                        <label for="dnim">*DNI de la Madre:</label>
                                                                    </div>
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <input id="dnip" type="number" class="validate" name="dnip" required="" maxlength="8">
