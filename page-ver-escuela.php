                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Escuela</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Escuela
                                            </li>
                                            <li class="active blue-text">Ver Escuela</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Ver Escuela</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos los datos de la escuela.
                                            </p>
                                            <div class="divider"></div>
                                            <div class="container">
                                                <!--DataTables example-->
                                                <div id="table-datatables">
                                                    <h4 class="header">Director:</h4>
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM escuela WHERE EscuelaEstReg='A'";
                                                                    $resultado = $conexion->query($consultaUser) or die($conexion->error);
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['EscuelaId'] . "</td>
                                                                        <td>" . $row['EscuelaNombre'] . "</td>                                                                       
                                                                        <td>" . $row['EscuelaTelefono'] . "</td>
                                                                        <td>" . $row['EscuelaDirector'] . "</td>
                                                                        <td>" . $row['EscuelaSecretaria'] . "</td>";
                                                                        
                                                                        
                                                                        echo "<td><a href=\"page-configurar-escuela.php?id=" . $row['EscuelaId'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarEscuela.php?id=" . $row['EscuelaId'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
