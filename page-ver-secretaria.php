                    ...
                    <section id="content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Secretaria</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Secretaria
                                            </li>
                                            <li class="active blue-text">Ver Secretaria</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Ver Secretaria</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos los datos de la secretaria.
                                            </p>
                                            <div class="divider"></div>
                                            <div class="container">
                                                <!--DataTables example-->
                                                <div id="table-datatables">
                                                    <h4 class="header">Secretaria:</h4>
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM secretaria WHERE SecretariaEstReg='A'";
                                                                    $resultado = $conexion->query($consultaUser) or die($conexion->error);
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['SecretariaDni'] . "</td>
                                                                        ...
                                                                        <td><a href=\"control/eliminarSecretaria.php?id=" . $row['SecretariaDni'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
                        ...
                        <div id="modal1" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Director no encontrado en la base de datos</p>
                            </div>
