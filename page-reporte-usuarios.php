                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Reporte de Usuarios</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Usuarios
                                            </li>
                                            <li class="active blue-text">Ver Reporte de Usuarios</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Reporte de Usuarios</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos los Reporte de Usuarios almacenadas en el sistema y poder gestionarlas.
                                            </p>
                                                            ...
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        ...
                                                                        <td>" . $row['UsuarioId'] . "</td>
                                                                        <td>" . $row['UsuarioContra'] . "</td>
                                                                        <td>" . $row['UsuarioTipoUsuario'] . "</td>
