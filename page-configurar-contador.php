                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Contador: <?php echo $provBD['ContadorDni']; ?></h4>
                                                        <div class="row">
                                                            <form id="configurar" class="col s12" action="control/modificarContador.php" method="POST">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="nombre" type="text" class="validate" name="nombreContador" required="" value="<?php echo $provBD['ContadorNombre']; ?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="apellido" type="text" class="validate" name="apellidoContador" required="" value="<?php echo $provBD['ContadorApellidos']; ?>">
