                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM contador WHERE ContadorEstReg='A'";
                                                                    $resultado = $conexion->query($consultaUser) or die($conexion->error);
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['ContadorDni'] . "</td>
                                                                        <td>" . $row['ContadorNombre'] . "</td>
                                                                        <td>" . $row['ContadorApellidos'] . "</td>
                                                                        <td>" . $row['ContadorCorreo'] . "</td>
                                                                        <td>" . $row['ContadorTelefono'] . "</td>";
                                                                        
                                                                        
                                                                        echo "<td><a href=\"page-configurar-contador.php?id=" . $row['ContadorDni'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarContador.php?id=" . $row['ContadorDni'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
