                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Modificar Vaucher</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de la Contabilidad
                                            </li>
                                            <li class="active blue-text" >Modificar Vaucher</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Modificar Voucher</h4>
                                            <p class="caption">
                                                En este panel usted podra Modificar Voucher con los que cuenta en la Escuela.
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Modificar Voucher</h4>
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="control/modificarVoucher.php" method="POST">
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="id" type="text" class="validate" name="id" required="" hidden="true" value="<?php echo $provBD['ContabilidadId']; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <input id="nombre" type="text" class="validate" name="ContabilidadAlumno" value="<?php echo $provBD['ContabilidadAlumno'];?>" required="">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col s12 m12 l12">
                                                                        ...
                                                                        <select id="disco" class="browser-default" name="ContabilidadConcepto" required="" value="<?php echo $provBD['ContabilidadConcepto'];?>">
