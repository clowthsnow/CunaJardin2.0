                    ...
                    <section id="content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Turnos</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Cursos
                                            </li>
                                            <li class="active blue-text">Ver Turnos</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Ver Turnos</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos los Turnos almacenadas en el sistema y poder gestionarlas.
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM turno WHERE TurnoEstReg='A'";
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        ...
                                                                        echo "<td><a href=\"page-configurar-turno.php?id=" . $row['TurnoId'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarTurno.php?id=" . $row['TurnoId'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
                        ...
                        <div id="modal1" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Turno no encontrado en la base de datos</p>
                            </div>
