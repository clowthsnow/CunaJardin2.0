...
//                                            echo "<br><br>";
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td valign="middle" rowspan="<?php echo $num['COUNT(*)'] + 1 ?>" class=" " > <center><?php echo $na; ?></center> </td>
                        ...
                        <div class="col m12 s12 l12 ">
                            <ul class="collection with-header">
                                ...
                                <table>
                                    ...
                                    ?>
                                    <td class=""><textarea readonly="" id="textarea1" class="materialize-textarea"  style="width: 90%; margin-left: 5%; "><?php echo $resdet['DetalleLibretaComentario']; ?></textarea></td>
                                    <td class=""></td>
                                    </tr>
                                    <tr>
