                ...
                <div class="wrapper">
                    ...
                    <section id="content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Crear Director</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Director
                                            </li>
                                            <li class="active blue-text" >Crear Director</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Creación de Nuevos datos del Director</h4>
                                            <p class="caption">
                                                En este panel usted podra crear nuevos datos para el Director.
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Nuevo Director</h4>
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="control/crearDirector.php" method="POST">
                        ...
                        <div id="modal2" class="modal">
                            ...
                            <div class="modal-footer">
                                <a href="page-crear-director.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
                        </div>
                    </section>
                    <!-- END CONTENT -->
