                ...
                <div class="wrapper">
                    ...
                    <section id="content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Registar Nuevo Pago</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de la Contabilidad
                                            </li>
                                            <li class="active blue-text" >Registar Nuevo Pago</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Registar Nuevo Pago</h4>
                                            <p class="caption">
                                                En este panel usted podra Registar Nuevo Pago con los que cuenta en la Escuela.
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Registar Nuevo Pago</h4>
                                                        <div class="row">
                                                            <div class="resp"></div>
                                                            ...
                                                            <form id="" method="POST" enctype="multipart/form-data" name="formulario">
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <input id="idpago" type="text" class="validate" name="idpago" required="">
                                                                        <label for="nombre">Codigo de Pago:</label>
                                                                    </div>

                                                                </div>
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <input id="AlumnoDni" type="text" class="validate" name="AlumnoDni" required="" maxlength="8" placeholder="Buscar...">
                                                                        <label for="AlumnoDni">Codigo de Alumno:</label>
                                                                    </div>
                                                                    <div class="input-field col s12 m6 l6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="fecha" type="text" class="datepicker" name="pagoFecha" required="" value="<?php echo $fecha->format('Y-m-d'); ?>">
                                                                        <label for="fecha" class="active">*Fecha de pago:</label>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="nombre" type="text" class="validate" name="pagoMonto" required="">
                                                                        <label for="nombre">Monto de pago:</label>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col s12 m6 l6">
                                                                        <label>*Tipo:</label>
                                                                        <select id="vivtipo" class="browser-default" name="pagoTipo" required="">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        ...
                                                                        <a href="page-ver-pagos.php" class="btn green">Listar Pagos</a>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                        ...
                        <div id="modal2" class="modal">
                            ...
                            <div class="modal-footer">
                                <a href="page-ver-pagos.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
                        </div>
                    </section>
                    <!-- END CONTENT -->
            ...
            $(function () {
                ...
                $('button[type=submit]').click(function (evento) {
                    ...
                    if (array[0].value == '' || array[1].value == '' || array[2].value == '' || array[3].value == '' || array[4].value == '') {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: 'control/crearPago.php',
                            data: {crearPago: 'sim', campos: array},
                            dataType: 'json',
                            beforeSend: function () {
