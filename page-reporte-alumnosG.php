...
if (!isset($_SESSION['usuario'])) {
    ...
    <html lang="es">
        ...
        <head>
            <title>Ver Estudiantes Matriculados</title>
        ...
        <body>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Estudiantes Matriculados</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Estudiantes Matriculados
                                            </li>
                                            <li class="active blue-text">Ver Estudiantes Matriculados</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Ver Estudiantes Matriculados</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos los Estudiantes Matriculados almacenadas en el sistema y poder gestionarlas.
                                            </p>
                                            ...
                                            <div class="container">
                                                ...
                                                <div id="table-datatables">
                                                    <h4 class="header">Estudiantes Matriculados:</h4>
                                                    <div class="row">
            ...
            <script>
                /*$(document).ready(function () {
                 $('#data-table-simple').DataTable().clear().destroy();
