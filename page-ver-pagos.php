                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Ver Pagos</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Pagos
                                            </li>
                                            <li class="active blue-text">Ver Pagos</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Ver Pagos</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todos los Pagos almacenados en el sistema y poder gestionarlas.
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM pago WHERE pagoEstReg='A'";
                                                                    $resultado = $conexion->query($consultaUser) or die($conexion->error);
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['idpago'] . "</td>";
                                                                        echo "<td>" . $row['AlumnoDni'] . "</td>";
                                                                        $consultaCat = "SELECT * FROM alumno WHERE AlumnoDni='" . $row['AlumnoDni'] . "'";
                                                                        ...
                                                                        echo "<td>" . $row['pagoFecha'] . "</td>";
                                                                        echo "<td>" . $row['pagoMonto'] . "</td>";
                                                                        echo "<td>" . $row['pagoTipo'] . "</td>";


                                                                        echo "<td><a href=\"page-configurar-nota.php?id=" . $row['idpago'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>
                                                                        <td><a href=\"control/eliminarNota.php?id=" . $row['idpago'] . "\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>
                                                                        </tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
                                                            ...
                                                            <br>
                                                            <a href="page-registrar-pago.php"class="btn">Registrar Pagos</a>
                                                        </div>
                                                    </div>
                                                </div> 
