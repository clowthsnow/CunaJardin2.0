                    ...
                    <section id="content">
                                        ...
                                        <div id="roboto">
                                            ...
                                            <div class="container">
                                                ...
                                                <div id="table-datatables">
                                                    ...
                                                    <br>
                                                    <a href="page-registrar-estudiante-1.php"class="btn">Registrar Nuevo</a>
                                                    <div class="row">
                        ...
                        <div id="modal1" class="modal">
                            ...
                            <div class="modal-footer">
                                <a href="page-ver-estudiantes-1.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
                        </div>
                        <!--modal eliminar-->
